...
=============================================
Compiles executive_summary.md into a high-level PDF brief for policy makers.
"""
...
MD_PATH = os.path.join(BASE_DIR, "executive_summary.md")
...
class ExecutivePDF(FPDF):
    def header(self):
        ...
        self.cell(0, 8, "CoralTwin-DT | Executive Policy Brief & Scientific Summary", 0, 1, "R")
...
def render_pdf():
    print(f"Generating Executive Summary PDF: {PDF_PATH}...")
    pdf = ExecutivePDF()
    ...
    pdf.output(PDF_PATH)
    print("Executive Summary PDF created.")
